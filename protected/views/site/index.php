    ...
    <ul class="style1">
        ...
        foreach($list as $key=>$value){
            ...
            <li style="padding-top: 5px;">
                ...
                <a class="pl-title" style="padding-top: 15px;" href="<?=Yii::app()->request->BaseUrl;?>/index.php/Posts/view/<?=$value['id'];?>">
                    <h5><?=$value['title'];?></h5>
                </a>
                   <!--显示内容 --><?/*=preg_replace('/\s(?=\s)/','',substr(strip_tags($value['content']),0,150));*/?>
            </li>
        <?php }?>
    </ul>
    <?php
